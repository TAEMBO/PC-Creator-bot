...
client.on("message", async (message) => {
	...
	if (message.content.startsWith(client.prefix)) {
		...
		// repeated messages
		if (message.content.length > 10 && ['.org','.com', '.ru', 'https://', 'http://', `@everyone`].some(x => message.content.toLowerCase().includes(x)) && message.guild.id === client.config.mainServer.id) {
