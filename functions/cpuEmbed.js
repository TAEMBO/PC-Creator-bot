module.exports = (client, options) => {
	...
	const embed = new client.embed()
		...
		.addField('Base Clock Speed', cpu.base ? (cpu.base === 'N/A' ? 'N/A' : cpu.base.toFixed(2) + ' GHz') : 'N/A', true)
		...
		.addField('Boost Clock Speed', cpu.boost ? (cpu.boost === 'N/A' ? 'N/A' : cpu.boost.toFixed(2) + ' GHz') : 'N/A', true)
